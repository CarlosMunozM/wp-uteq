...
export { FormMatricula };

function FormMatricula(codMaestria, dataMsc, urlVideoTut, estdPerdMatc) {
    ...
    const [filesDoc1, setFilesDoc1] = useState([]);
                                ...
                                <form className="form-card" encType="multipart/form-data" onSubmit={handleSubmit(onSubmit)}>
                                    <div className="row justify-content-between text-left g-0">
                                        ...
                                        <div className="alert alert-success alert-form" role="alert">
                                            ...
                                            <hr />
                                            Los programas de Maestrías que se muestran en la lista desplegable son aquellos que tienen aperturado el período de matriculación.
                                            El título de tercer nivel debe tener la legalización consular o apostilla de La Haya.
                                    ...
                                    <div className="row justify-content-between text-left">
                                        ...
                                        <div className="form-group col-sm-6 flex-column d-flex">
                                            <label className="form-control-label px-3" htmlFor="txtphone">Celular *</label>
                                            <PhoneInput
                                    ...
                                    <div className="row justify-content-between text-left">
                                        {UploadFile("Documento de identidad C.I/C.C/Pasaporte *", true)}
                                    </div>
                                    {
                                        mesg != "" && (
