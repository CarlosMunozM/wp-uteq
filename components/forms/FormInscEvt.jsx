...
function FormInscEvt(dataCountries, dataSymps, language) {
    ...
    const [isInstitDisabled, setIsInstitDisabled] = useState(false);
    const [isCarreraDisabled, setIsCarreraDisabled] = useState(false);
    ...
    const validationMessages = {
        es: {
            ...
            pcTipoUs: {
                required: 'El campo Perfil de usuario es requerido',
                options: [
                    { coderep: 0, value: '', label: 'Seleccione una opción' },
                    { coderep: 1, value: 'Docente - UTEQ', label: 'Docente - UTEQ' },
                    { coderep: 2, value: 'Estudiante - UTEQ', label: 'Estudiante - UTEQ' },
                    { coderep: 3, value: 'Público General', label: 'Público General' },
                ]
            },
            pcCarrera: {
                ...
                options: [
                    ...
                    { value: 'Nivelación', label: 'Nivelación' },
                    ...
                    { value: 'Agroecología', label: 'Agroecología' },
                    ...
                    { value: 'Contabilidad y Auditoría', label: 'Contabilidad y Auditoría' },
                    ...
                    { value: 'Pedagogía de los Idiomas Nacionales y Extranjeros', label: 'Pedagogía de los Idiomas Nacionales y Extranjeros' },
            ...
            labelsForm: {
                ...
                label35: 'Profesión *',
                label36: 'El campo Profesión es requerido',
                label37: 'Profesión *',
                ...
                label50: 'Perfil de usuario *',
                label51: 'El campo Perfil de usuario es requerido',
                label52: 'Carrera *',
                label53: 'El campo Carrera es requerido',
            },
        },
        en: {
            pcTipoInc: {
            ...
            pcTipoUs: {
                required: 'The User Profile field is required',
                options: [
                    { coderep: 0, value: '', label: 'Select an option' },
                    { coderep: 1, value: 'Teacher - UTEQ', label: 'Teacher - UTEQ' },
                    { coderep: 2, value: 'Student - UTEQ', label: 'Student - UTEQ' },
                    { coderep: 3, value: 'General Public', label: 'General Public' },
                ]
            },
            pcCarrera: {
                required: 'The Career field is required',
                options: [
                    { value: '', label: 'Select an option' },
                    { value: 'Levelling', label: 'Levelling' },
                    ...
                    { value: 'Human Talent Management', label: 'Human Talent Management' },
                    ...
                    { value: 'Pedagogy of National and Foreign Languages', label: 'Pedagogy of National and Foreign Languages' },
                    { value: 'Psychopedagogy', label: 'Psychopedagogy' },
                    { value: 'Public Administration', label: 'Public Administration' },
                    { value: 'Software', label: 'Software' },
                    { value: 'Telematics', label: 'Telematics' },
                    { value: 'Tourism', label: 'Tourism' },
                    { value: 'Zootechnics', label: 'Zootechnics' }
                ]
            },
            pcInstitc: {
            ...
            labelsForm: {
                ...
                label35: 'Profession *',
                label36: 'The Profession field is required',
                label37: 'Profession *',
                ...
                label50: 'User Profile *',
                label51: 'The User Profile field is required',
                label52: 'Career *',
                label53: 'The Career field is required',
            },
        },
        pt: {
            pcTipoInc: {
            ...
            pcTipoUs: {
                required: 'O campo Perfil de Usuário é obrigatório',
                options: [
                    { coderep: 0, value: '', label: 'Selecione uma opção' },
                    { coderep: 1, value: 'Docente - UTEQ', label: 'Docente - UTEQ' },
                    { coderep: 2, value: 'Estudante - UTEQ', label: 'Estudante - UTEQ' },
                    { coderep: 3, value: 'Público Geral', label: 'Público Geral' },
                ]
            },
            pcCarrera: {
                required: 'O campo Carreira é obrigatório',
                options: [
                    { value: '', label: 'Selecione uma opção' },
                    { value: 'Nivelamento', label: 'Nivelamento' },
                    ...
                    { value: 'Engenharia Industrial', label: 'Engenharia Industrial' },
                    { value: 'Finanças', label: 'Finanças' },
                    { value: 'Gestão de Talentos Humanos', label: 'Gestão de Talentos Humanos' },
                    { value: 'Mecânica', label: 'Mecânica' },
                    { value: 'Marketing', label: 'Marketing' },
                    { value: 'Pedagogia das Línguas Nacionais e Estrangeiras', label: 'Pedagogia das Línguas Nacionais e Estrangeiras' },
                    { value: 'Psicopedagogia', label: 'Psicopedagogia' },
                    { value: 'Segurança Industrial', label: 'Segurança Industrial' },
            ...
            labelsForm: {
                ...
                label35: 'Profissão *',
                label36: 'O campo Profissão é obrigatório',
                label37: 'Profissão *',
                ...
                label50: 'Perfil de Usuário *',
                label51: 'O campo Perfil de Usuário é obrigatório',
                label52: 'Carreira *',
                label53: 'O campo Carreira é obrigatório',
            },
        },
    };
    ...
    const validationSchema = Yup.object().shape({
        ...
        pcTipoUs: Yup.string().required(validationMessages[language].pcTipoUs.required),
        pcCarrera: Yup.string()
            .transform(v => (v === '' ? undefined : v))
            .when('pcTipoUs', {
                is: (tipo) => {
                    if (language === 'es') {
                        return tipo === 'Docente - UTEQ' || tipo === 'Estudiante - UTEQ';
                    }
                    if (language === 'en') {
                        return tipo === 'Teacher - UTEQ' || tipo === 'Student - UTEQ';
                    }
                    if (language === 'pt') {
                        return tipo === 'Docente - UTEQ' || tipo === 'Estudante - UTEQ';
                    }
                    return false;
                },
                then: (schema) =>
                    schema.required(validationMessages[language].pcCarrera.required),
        ...
        pcEspecld: Yup.string()
            ...
            .when('pcTipoUs', {
                is: (tipo) => {
                    if (language === 'es') {
                        return tipo === 'Público General';
                    }
                    if (language === 'en') {
                        return tipo === 'General Public';
                    }
                    if (language === 'pt') {
                        return tipo === 'Público Geral';
                    }
                    return false;
                },
                then: (schema) =>
    ...
    const { register, setValue, handleSubmit, reset, formState: { errors }, clearErrors } = useForm(formOptions);
    ...
    useEffect(() => {
        ...
        const select = document.getElementById('slct-tipous');
        if (!select) return;

        const fakeEvent = { target: select };
        eventOnChangeTipoUsuario(fakeEvent);
    }, [countryPhn, country]);
    ...
    const eventOnChangeTipoUsuario = (event) => {
        const select = event.target;
        const selectedOption = select.options[select.selectedIndex];
        const dataOpcion = selectedOption.getAttribute('data-opcion');

        if (dataOpcion === '1' || dataOpcion === '2') {
            setIsInstitDisabled(true);
            setIsCarreraDisabled(false);
            setShowCarrera(true);
            setShowEspecialidad(false);
            setValue('pcCarrera', '');
            setValue('pcInstitc', 'Universidad Técnica Estatal de Quevedo');
            setValue('pcEspecld', '');
        } else if (dataOpcion === '3') {
            setIsInstitDisabled(false);
            setIsCarreraDisabled(true);
    ...
    const getEspecialidad = (tipo, carrera, especialidad, language) => {
        if (language === 'es') {
            if (tipo === 'Docente - UTEQ' || tipo === 'Estudiante - UTEQ') return carrera;
            if (tipo === 'Público General') return especialidad;
        }

        if (language === 'en') {
            if (tipo === 'Teacher - UTEQ' || tipo === 'Student - UTEQ') return carrera;
            if (tipo === 'General Public') return especialidad;
        }

        if (language === 'pt') {
            if (tipo === 'Docente - UTEQ' || tipo === 'Estudante - UTEQ') return carrera;
            if (tipo === 'Público Geral') return especialidad;
        }
                                        ...
                                        await axios.post(`${WS_VALIDATE_FORM}${token}`).then(function (response) {
                                            if (response.data === "OK") {
                                                axios.post(WS_REGISTER_USER_EVENT, {
                                                    ...
                                                    usEspecialidad: /*data.pcEspecld*/ getEspecialidad(
                                                        data.pcTipoUs,
                                                        data.pcCarrera,
                                                        data.pcEspecld,
                                                        language
                                                    ),
                                                    usProfesion: /*data.pcProfs*/ data.pcTipoUs,
                        ...
                        <div className="card-body pnl-bdy-symp">
                            ...
                            <div className="row justify-content-between text-left">
                                ...
                                <div className="form-group col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 flex-column d-flex">
                                    ...
                                    <select name="pcGenero" {...register('pcGenero')} className={`form-select form-select-lg ${errors.pcGenero ? 'is-invalid' : ''}`}
                                        id="slct-genero" data-error={validationMessages[language].labelsForm.label28}>
                                        <option value="" >{validationMessages[language].labelsForm.label7}</option>
                            ...
                            <div className="row justify-content-between text-left">
                                ...
                                <div className="form-group col-12 col-sm-12 col-md-6 col-lg-3 col-xl-2 col-xxl-2 flex-column d-flex">
                                    <label className="form-control-label px-3" htmlFor="slct-ciudad">{validationMessages[language].labelsForm.label50}</label>
                                    <select name="pcTipoUs" {...register('pcTipoUs', {
                                        onChange: (e) => {
                                            eventOnChangeTipoUsuario(e);
                                        }
                                    })} className={`form-select form-select-lg ${errors.pcTipoUs ? 'is-invalid' : ''}`}
                                        id="slct-tipous" data-error={validationMessages[language].labelsForm.label51}>
                                        {validationMessages[language].pcTipoUs.options.map((opt, index) => (
                                            <option
                                                key={index}
                                                value={opt.value}
                                                data-opcion={opt.coderep}
                                                disabled={opt.value === '' && index === 0}>
                                                {opt.label}
                                            </option>
                                        ))}
                                    </select>
                                    <div className="invalid-feedback">{errors.pcTipoUs?.message}</div>
                                </div>
                                <div className={
                                    `form-group col-12 col-sm-12 col-md-6 col-lg-3 col-xl-4 col-xxl-4 flex-column d-flex ` +
                                    (!showCarrera ? 'd-none' : '')
                                }>
                                    <label className="form-control-label px-3" htmlFor="slct-carreraus">{validationMessages[language].labelsForm.label52}</label>
                                    <select name="pcCarrera" {...register('pcCarrera')} className={`form-select form-select-lg ${errors.pcCarrera ? 'is-invalid' : ''}`}
                                        id="slct-carreraus" data-error={validationMessages[language].labelsForm.label53} disabled={isCarreraDisabled}>
                                        {validationMessages[language].pcCarrera.options.map((opt, index) => (
                                            <option
                                                key={index}
                                                value={opt.value}
                                                disabled={opt.value === '' && index === 0}>
                                    ...
                                    <div className="invalid-feedback">{errors.pcCarrera?.message}</div>
                                </div>
                                <div className={
                                    `form-group col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 flex-column d-flex ` +
                                    (!showEspecialidad ? 'd-none' : '')
                                }>
                                ...
                                <div className="form-group col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 flex-column d-flex">
                                    ...
                                    <input type="text" id="txt-instc" className={`form-control ${errors.pcInstitc ? 'is-invalid' : ''}`} name="pcInstitc" {...register('pcInstitc')} data-error={validationMessages[language].labelsForm.label34} disabled={isInstitDisabled} />
