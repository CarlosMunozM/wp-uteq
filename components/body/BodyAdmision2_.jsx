                    ...
                    <div className="row g-0 slider-text align-items-center justify-content-end" data-scrollax-parent="true">
                        <div className="col-10 col-sm-10 col-md-5 ftco-animate custom-left-column p-4 me-md-2 mx-auto">
                            <h1 className="mb-4">
                                ...
                                {data.language === "es"
                                    ? "Registro local - Primer período 2026"
                                    : (data.language === "en"
                                        ? "Local Registration – First Period 2026"
                                        : "Registro Local – Primeiro Período de 2026")}
                            </h1>
                            <p className="mb-3">
                                {data.language === "es"
                                    ? "Para continuar en esta fase, debes haber realizado el Registro Nacional Único de la Senescyt."
                                    : (data.language === "en"
                                        ? "To continue in this phase, you must have completed the Senescyt Single National Registration."
                                        : "Para continuar nesta fase, você deve ter realizado o Registro Nacional Único da Senescyt.")}
                            </p>
                            <p className="mb-4 fw-bold">
                                {data.language === "es"
                                    ? "Del 23 de diciembre de 2025 al 24 de febrero de 2026"
                                    : (data.language === "en"
                                        ? "From 23 December 2025 to 24 February 2026"
                        ...
                        {/*<a
                                ...
                                aria-label={
                                    data.language === "es"
                                        ? "Ir al proceso de admisión"
                                        : (data.language === "en"
                                            ? "Go to the admission process"
                                            : "Ir para o processo de admissão")
                                }
                            >
                                {data.language === "es"
                                    ? "Inscríbete aquí"
                        ...
                        <div className="col-sm-12 col-md-8 col-lg-6">
                            <div className="panel-1-sect-4">
                                ...
                                <div className="d-flex flex-column justify-content-center h-100">
                                    ...
                                    <ol className="mb-4">
                                        <li>{data.language === "es" ? "Registro nacional en SENESCYT" : (data.language === "en" ? "National Registration in SENESCYT" : "Registro Nacional no SENESCYT")}</li>
                                        ...
                                        <li>{data.language === "es" ? "Aceptación de cupo - SENESCYT" : (data.language === "en" ? "Acceptance of slot - SENESCYT" : "Aceitação de vaga - SENESCYT")}</li>
                                    </ol>
                                    <a
                                        href={`/${data.language}/admision/proceso-de-admision`}
                                        target="_blank"
