                ...
                <Tabs defaultActiveKey={0} id="tab-info">
                    <Tab eventKey={0} title={data.language === "es" ? "Acerca De" : (data.language === "en" ? "About" : "Sobre")}>
                        <div className="paragraph-cont">
                            <div dangerouslySetInnerHTML={sanitizedData(data.language === "es" ? data.data8.pwDescripcion.trim() : (data.language === "en" ? data.data8.pwDescripcionEn.trim() : data.data8.pwDescripcionPt.trim()))}></div>
                            {
                                <div className="col-md-12 w-100 paragraph-cont" dangerouslySetInnerHTML={sanitizedData((data.language === "es" ? ((data.data8.pwMision !== null && data.data8.pwMision !== "") ? data.data8.pwMision.trim() : '') :
                                    (data.language === "en" ? ((data.data8.pwMisionEn !== null && data.data8.pwMisionEn !== "") ? data.data8.pwMisionEn.trim() : '') :
                                        (data.data8.pwMisionPt !== null && data.data8.pwMisionPt !== "") ? data.data8.pwMisionPt.trim() : '')) +
                                    (data.language === "es" ? ((data.data8.pwVision !== null && data.data8.pwVision !== "") ? data.data8.pwVision : '') :
                                        (data.language === "en" ? ((data.data8.pwVisionEn !== null && data.data8.pwVisionEn !== "") ? data.data8.pwVisionEn : '') :
                                            (data.data8.pwVisionPt !== null && data.data8.pwVisionPt !== "") ? data.data8.pwVisionPt : '')) +
                                    (data.language === "es" ? ((data.data8.pwObjetivos !== null && data.data8.pwObjetivos !== "") ? data.data8.pwObjetivos : '') :
                                        (data.language === "en" ? ((data.data8.pwObjetivosEn !== null && data.data8.pwObjetivosEn !== "") ? data.data8.pwObjetivosEn : '') :
                                            ((data.data8.pwObjetivosPt !== null && data.data8.pwObjetivosPt !== "") ? data.data8.pwObjetivosPt : '')))
                                )}></div>
                            }
                            {
                    ...
                    {/*<Tab eventKey={1} title="Responsable">
