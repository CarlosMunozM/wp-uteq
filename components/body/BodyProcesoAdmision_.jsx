                    ...
                    {/*<div className="row mb-4">
                        <div className="col-12 col-sm-12 col-md-9 col-lg-6">
                            <div className="d-flex flex-column justify-content-center h-100">
                                <h2 className="mb-4">Fase 0. Registro nacional en Senescyt</h2>
                                <p className="mb-4">
                                    Es un requisito obligatorio para poder iniciar el proceso de admisión en la UTEQ. Este paso es esencial para acceder a las universidades públicas del Ecuador. No olvides completarlo para dar inicio a tu camino académico.<br /><span>Del 30 de noviembre 2024 al 8 de diciembre 2024</span>
                                </p>
                    ...
                    <div className="row mb-4">
                        <div className="col-12 col-sm-12 col-md-9 col-lg-6">
                            <div className="d-flex flex-column justify-content-center h-100">
                                <h2 className="mb-4">
                                    {data.language === "es"
                                        ? "Fase 0. Registro nacional en Senescyt"
                                        : (data.language === "en"
                                            ? "Phase 0. National Registration in Senescyt"
                                            : "Fase 0. Registro nacional no Senescyt")}
                                </h2>
                                <p className="mb-4">
                                    {data.language === "es"
                                    ...
                                    <span>
                                        {data.language === "es"
                                            ? "Del 27 de noviembre al 3 de diciembre de 2025"
                                            : (data.language === "en"
                                                ? "From 27 November to 3 December 2025"
                                                : "De 27 de novembro a 3 de dezembro de 2025")}
                                    </span>
                                </p>
                            	...
                            	<span className="badge-state-phase">
                                    {data.language === "es"
                                        ? "La fase ya se encuentra finalizada"
                                        : (data.language === "en"
                            ...
                            <div className="d-flex flex-column justify-content-center h-100">
                                ...
                                <p className="mb-4">
                                    {data.language === "es"
                                        ? "Para continuar en esta fase, debes haber realizado el Registro Nacional Único de la Senescyt. Deberás realizar lo siguiente:"
                                        : (data.language === "en"
                                            ? "To continue in this phase, you must have completed the Senescyt National Registration. You need to do the following:"
                                            : "Para continuar nesta fase, você deve ter realizado o Registro Nacional Único da Senescyt. Você deve fazer o seguinte:")}
                                </p>
                                <ul className="mb-1">
                                    <li>
                                        {data.language === "es"
                                    ...
                                    <li>
                                        ...
                                        <a href="https://postulate.uteq.edu.ec/loginpostulacion" aria-label="Postúlate en la UTEQ, accede a la página de inscripción" target="_blank" rel="noopener noreferrer">
                                            Postúlate UTEQ
                                        </a>.
                                    </li>
                                    <li>
                                ...
                                {<span className="text-date-phase mb-4">
                                    {data.language === "es"
                                        ? "Del 23 de diciembre 2025 al 24 de febrero 2026"
                                        : (data.language === "en"
                                            ? "From December 23, 2025, to February 24, 2026"
                                            : "De 23 de dezembro de 2025 a 24 de fevereiro de 2026")}
                                </span>}
                            {/*<span className="badge-state-phase">
                                    {data.language === "es"
                            	...
                            	<span className="badge-state-phase">
                                    {data.language === "es"
                                        ? "La fase iniciará pronto"
                                        : (data.language === "en"
                                            ? "The phase will begin soon"
                    ...
                    <div className="row mt-4 mb-4">
                        <div className="col-12 col-sm-12 col-md-9 col-lg-6">
                            <div className="d-flex flex-column justify-content-center h-100">
                                ...
                                {/*<span className="text-date-phase mb-4">
                                    {data.language === "es"
                                        ? "Del 14 de enero al 17 de febrero 2025"
                                        : (data.language === "en"
                                            ? "From January 14 to February 17, 2025"
                                            : "De 14 de janeiro a 17 de fevereiro de 2025")}
                                </span>*/}
                            {/*<span className="badge-state-phase">
                                    {data.language === "es"
                    ...
                    <div className="row mt-4 mb-4">
                        ...
                        <div className="col-12 col-sm-12 col-md-9 col-lg-6">
                            <div className="d-flex flex-column justify-content-center h-100">
                            	...
                            	{/*<span className="text-date-phase mb-4">
                                    {data.language === "es"
                                        ? "Del 25 de julio al 4 de agosto 2025"
                                        : (data.language === "en"
                                            ? "25 July to 4 August 2025"
                                            : "25 de julho a 4 de agosto de 2025")}
                                </span>*/}
                    ...
                    <div className="row mt-4 mb-4">
                        <div className="col-12 col-sm-12 col-md-9 col-lg-6">
                            <div className="d-flex flex-column justify-content-center h-100">
                                ...
                                {/*<span className="text-date-phase mb-4">
                                    {data.language === "es"
                                        ? "12 al 28 de agosto 2025"
                                        : (data.language === "en"
                                            ? "August 12th to 28th, 2025"
                                            : "12 a 28 de agosto de 2025")}
                                </span>
                                <span className="badge-state-phase">
                                    {data.language === "es"
                                        ? "La fase se encuentra finalizada"
                    ...
                    <div className="row mt-4 mb-4">
                        <div className="col-12 col-sm-12 col-md-9 col-lg-6">
                            <div className="d-flex flex-column justify-content-center h-100">
                                <h2 className="mb-4">
                                    {data.language === "es"
                                        ? "Fase 6. Aceptación de cupos - Senescyt"
                                        : (data.language === "en"
                                            ? "Phase 6. Seat Acceptance - Senescyt"
                                            : "Fase 6. Aceitação de vagas - Senescyt")}
                                </h2>
                                <p className="mb-4">
                                    {data.language === "es"
                                        ? "Para continuar en esta fase, debes haber realizado el Registro Nacional Único de la Senescyt. Deberás realizar lo siguiente:"
                                        : (data.language === "en"
                                            ? "To continue in this phase, you must have completed the Senescyt National Unique Registration. You must do the following:"
                                            : "Para continuar nesta fase, você deve ter realizado o Registro Nacional Único da Senescyt. Você deve fazer o seguinte:")}
                                </p>
                                <ul className="mb-4">
                                    <li>
                                    ...
                                    <li>
                                        {data.language === "es"
                                            ? "Ingresa tu usuario y contraseña del Registro Nacional Único de la Senescyt."
                                            : (data.language === "en"
                                                ? "Enter your username and password from the Senescyt National Unique Registration."
                                                : "Digite seu nome de usuário e senha do Registro Nacional Único da Senescyt.")}
                                    </li>
                                    <li>
                                        {data.language === "es"
                                ...
                                {/*<span className="text-date-phase mb-4">
                                    {data.language === "es"
                                        ? "14 de agosto al 1 de septiembre de 2025"
                                        : (data.language === "en"
                                            ? "August 14 to September 1, 2025"
                                            : "14 de agosto a 1 de setembro de 2025")}
                                </span>
                                <span className="badge-state-phase">
                                    {data.language === "es"
                                        ? "La fase se encuentra finalizada"
