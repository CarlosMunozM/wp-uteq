...
export default function Custom500() {
    ...
    return (<div className="row g-0">
        ...
        <div className="col-md-12 mt-3" style={{ padding: "10px" }}>
            <h1 className="text-error text-center" style={{ fontSize: "70px", color: "#025a27", fontWeight: "bold", fontFamily: "open-sans-light", marginTop: "15px" }}>{router.locale === "pt" ? "Erro 500" : "Error 500"}</h1><br />
            <h1 className="text-error text-center" style={{ fontSize: "40px", color: "#2D2D2D", fontFamily: "open-sans-light" }}>{router.locale === "es" ? "Ocurrió un error en el servidor" : (router.locale === "en" ? "A server error occurred" : "Ocorreu um erro no servidor")}</h1>
        </div>
        <div className="col-md-12 mt-3" style={{ padding: "10px" }}>
