...
import { WS_LIST_DATA_GENERAL_NUM1, FRONT_PG_IMGS_FOLDER, apiUrl, WS_LIST_VIDEOS_UNIV_BY_TYPE, WS_INFORMATION_PAGE_WEB, WS_LIST_ITEMS_MENU_LAT_BY_LANG } from 'config';
...
export const getStaticProps = async ({ locale }) => {
    ...
    const resInfoPageWeb = await make_request_ws(`${WS_INFORMATION_PAGE_WEB}785bd070-c0f5-4db1-95b0-b936572df74f`);
    ...
    return {
        props: {
            ...
            urlpageweb: `${apiUrl}/${locale}/investigacion/grupos`,
            urlimage: `${FRONT_PG_IMGS_FOLDER}${locale==="es"?"imagen_grupos_investigacion_uteq_es.jpg":(locale==="en"?"imagen_grupos_investigacion_uteq_en.jpg":"imagen_grupos_investigacion_uteq_pt.jpg")}`,
